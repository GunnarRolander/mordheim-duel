import { toHitPhase, toWoundPhase, injuryPhase, doRecovery, setUpAttacks } from './combat.js';
...
export const runTests = () => {
  ...
  let {status, old_status} = testDoRecovery(warrior_1, "knocked down")
  ...
  console.assert(old_status === "standing", "Knocked down warrior, recovery old_status is not standing")
  ...
  console.assert(warrior_1.status === "knocked down", "Stunned warrior, recovery status is not knocked down")
  ...
  console.assert(warrior_1.status === "out of action", "Out of action warrior, recovery status is not out of action")
